...
* +v(vdd)=1.8
* +v(vss)=0.0
* +v(xsky130_asc_cap_mim_m3_1_6.x2.b1)=0.7174046130623679
* +v(xsky130_asc_cap_mim_m3_1_6.x3.a)=0.7174046129589241
* +v(xsky130_asc_cap_mim_m3_1_6.x3.b1)=0.7174046130623679
* .save all
.nodeset v(bgr)=0.9648902730065814
+v(g_new)=1.3611060018584489
.save all
.op
.tf v(bgr) vtest
.END